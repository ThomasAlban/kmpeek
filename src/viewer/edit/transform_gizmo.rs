...
use crate::{ui::ui_state::ViewportRect, viewer::kmp::components::KmpSelectablePoint};
use bevy::prelude::*;
...
fn update_gizmo(
    ...
    if viewport_rect.is_changed() {
        gizmo_options.viewport_rect = Some(viewport_rect.0);
    }
    // update gizmo mode
